...
export default function Navbar({ sidebar, setSidebar }) {
    ...
    const { account, setAccount, ethers, contractABI, contractAddress } = useContext(AccountContext);

    useEffect(() => {
        const connectWallet = async () => {
            console.log('Connecting wallet inside of useEffect...');
            try {
    ...
    const getWalletBalance = async () => {
        if (typeof window.ethereum === 'undefined') {
            ...
            try {
                console.log("ther", ethers.providers);
    ...
    const chainData = {
        ...
        rpcUrls: ['https://rpc.sepolia.org'], // Sepolia RPC URL
    ...
    const handleWalletConnection = async () => {
        ...
        if (provider !== window.ethereum) {
            console.error('Please make sure MetaMask is the active provider.');
            return;
        }
            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        ...
                        {isLogin && <li>
                            <Link to="/wallet/3" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Wallet</Link>
                        </li>}
                        <li onClick={getWalletBalance}>
                            <span className="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Current Balance: {balance*10000}</span>
                        </li>
                    </ul>
                </div>
            </div>
